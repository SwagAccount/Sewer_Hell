...
PS
{
	...
	float g_flFuck < UiGroup( ",0/,0/0" ); Default1( 0 ); Range1( 0, 1 ); >;
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float l_1 = g_flFuck;
		float l_2 = l_1 * 100;
		float2 l_3 = TileAndOffsetUv( i.vTextureCoords.xy, float2( l_2, l_2 ), float2( 0, 0 ) );
		float l_4 = Simplex2D( l_3 );
		float l_5 = l_4 * 100;
		float l_6 = max( l_5, l_1 );
		float l_7 = 1 - l_6;
