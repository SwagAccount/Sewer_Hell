...
PS
{
	...
	float2 g_vTile < UiGroup( ",0/,0/0" ); Default2( 1,1 ); Range2( 0,0, 1,1 ); >;
	float g_flTrans < UiGroup( ",0/,0/0" ); Default1( 1 ); Range1( 0, 1 ); >;
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float4 l_2 = Tex2DS( g_tTexture_ps_0, g_sSampler0, l_1 );
		float l_3 = g_flTrans;
